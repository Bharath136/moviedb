...
const UpcomingMovie = () => {
    ...
    const upcomingApi = 'https://api.themoviedb.org/3/movie/upcoming?api_key=75c13cdf625213f137e50124e566ec92&language=en-US&page=1';
    ...
    useEffect(() => {
        const fetchUpcomingMovies = async () => {
            try {
                const response = await axios.get(upcomingApi);
